...
if __name__ == "__main__":
    k = build()
    print(f"Knowledge base compiled: {len(k['sections'])} sections -> {OUTPUT_FILE}")
    print(f"Business: {k['business_name']}")
    print(f"Total characters in raw_text: {len(k['raw_text'])}")
